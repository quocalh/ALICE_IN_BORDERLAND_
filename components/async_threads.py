...
class AsyncThreads(threading.Thread):
    thread_id: int = 0
    def __init__(self, action_queue: queue.Queue, group = None, target = None, name = None, args = ..., kwargs = None, *, daemon = None):
...
if __name__ == "__main__":
    ...
    compute_thread = AsyncThreads(the_threading_queue)
